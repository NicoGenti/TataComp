    ...
    <div classname="min-h-screen bg-slate-900 text-white py-20 px-6">
      <div classname="container mx-auto max-w-4xl">
        ...
        <header classname="text-center mb-16">
          <motion.div initial="{{" scale:="" 0="" }}="" animate="{{" scale:="" 1="" }}="" transition="{{" type:="" "spring",="" stiffness:="" 260,="" damping:="" 20="" }}="" classname="inline-flex items-center justify-center w-20 h-20 bg-rose-500 rounded-full mb-6 shadow-lg shadow-rose-500/20">
            <camera size="{32}"/>
          </motion.div>
          <motion.h1 initial="{{" opacity:="" 0,="" y:="" 20="" }}="" animate="{{" opacity:="" 1,="" y:="" 0="" }}="" classname="text-4xl md:text-6xl font-black tracking-tight mb-4">
        ...
        <div classname="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {FUNNY_PHOTOS.map((photo, index) => (
            <motion.div key="{photo.id}" initial="{{" opacity:="" 0,="" y:="" 20="" }}="" animate="{{" opacity:="" 1,="" y:="" 0="" }}="" transition="{{" delay:="" 0.1="" *="" index="" }}="" whilehover="{{" scale:="" 1.02="" }}="" classname="group relative aspect-square rounded-3xl overflow-hidden bg-slate-800 border border-slate-700 shadow-xl">
              <img src="{photo.url}" alt="{photo.caption}" classname="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" referrerpolicy="no-referrer"/>
        ...
        <motion.div initial="{{" opacity:="" 0="" }}="" whileinview="{{" opacity:="" 1="" }}="" viewport="{{" once:="" true="" }}="" classname="mt-20 text-center p-12 rounded-[3rem] bg-white/5 backdrop-blur-sm border border-white/10">
