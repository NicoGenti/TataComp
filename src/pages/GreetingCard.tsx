  ...
  return (
    <div className="min-h-screen bg-pink-100 flex items-center justify-center p-6 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-rose-100"
        style={{ perspective: 1000 }}
      >
        {/* Envelope flap design */}
        <div
          className="absolute top-0 left-0 w-full h-32 bg-rose-50 border-b border-rose-100"
        ...
        <div className="relative z-10 p-10 pt-20 text-center flex flex-col items-center">
          <motion.div
            ...
            className="w-16 h-16 bg-rose-100 rounded-full flex items-center justify-center mb-6 text-rose-500 shadow-inner"
          >
          ...
          <motion.h1
            ...
            className="text-3xl font-serif font-bold text-slate-800 mb-4"
          >
